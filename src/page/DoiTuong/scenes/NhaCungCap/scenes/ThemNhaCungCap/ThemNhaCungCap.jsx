...
const ThemNhaCungCap = ({ disabled = false }) => {
    ...
    useEffect(() => {
        // dispatch(getChungTu({ pageNumber: 0, pageSize:8, sortBy:"createAt", sortOrder:"des", id: id }));
    }, []);
                    ...
                    <Flex vertical gap={5} className='w-[50%]'>
                        ...
                        >
                            ...
                            >
                                ...
                                <Select.Option value="abc">abxc</Select.Option>
                            </Select>
                        </Form.Item>

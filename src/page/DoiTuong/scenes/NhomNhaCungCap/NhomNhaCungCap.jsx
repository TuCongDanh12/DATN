...
import { clearState, doiTuongSelector, getListSupplier, getListSupplierGroup, postSupplierGroup } from '../../../../store/features/doiTuongSilce';
    ...
    return (
        <div className='m-4'>
            <div className='px-[20px] w-full flex justify-between py-7 bg-white'>
                ...
                >
                    <div className='m-8 mt-10 text-center'>Bạn muốn xóa nhóm nhà cung cấp<br /> <strong>"{dataSelected.name}"</strong>?</div>
            ...
            <Table
                ...
                // }}
                columns={columns}
                dataSource={listSupplierGroupData}
                pagination={{
